    ...
    pub async fn start(
        ...
        let proxy_routes = Router::new()
            ...
            .route(
                ...
                post(handlers::gemini::handle_list_models),
            )
        ...
        // [MITM v7] Start forward proxy for native IDE telemetry interception
        let mitm_port = port + 1;
        match crate::proxy::mitm::ca::CertificateAuthority::load_or_generate() {
            Ok(ca) => {
                ...
                tokio::spawn(async move {
                    if let Err(e) = crate::proxy::mitm::forward_proxy::start(
                        ca_clone,
                        mitm_port,
                        proxy_pool_clone,
                        token_manager_clone,
